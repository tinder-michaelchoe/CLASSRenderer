//
//  SCALSValidator.swift
//  SCALS
//
//  JSON schema validation for SCALS documents.
//
...
/// Errors that can occur during SCALS document validation
public enum SCALSValidationError: Error, CustomStringConvertible {
    ...
    case multipleErrors([SCALSValidationError])
...
public struct SCALSValidationResult {
    ...
    public init(isValid: Bool, errors: [SCALSValidationError] = [], warnings: [String] = [], document: Document.Definition? = nil) {
...
// MARK: - SCALS Validator

/// Validates SCALS JSON documents against the schema
public struct SCALSValidator {
    ...
    public func validate(jsonString: String) -> SCALSValidationResult {
        guard let data = jsonString.data(using: .utf8) else {
            return SCALSValidationResult(
                isValid: false,
    ...
    /// Validate JSON data
    public func validate(jsonData: Data) -> SCALSValidationResult {
        var errors: [SCALSValidationError] = []
        var warnings: [String] = []
    ...
    private func validateDocument(_ doc: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
        // Required: id
        if doc["id"] == nil {
    ...
    private func validateRootComponent(_ root: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
        // Required: children
    ...
    private func validateLayoutNode(_ node: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
    ...
    private func validateLayout(_ layout: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
    ...
    private func validateSectionLayout(_ sectionLayout: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
    ...
    private func validateSectionDefinition(_ section: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
    ...
    private func validateSectionLayoutConfig(_ config: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
    ...
    private func validateForEach(_ forEach: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
        // Required: items
    ...
    private func validateComponent(_ component: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
    ...
    private func validateStyle(_ style: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
        // Validate fontWeight
    ...
    private func validateAction(_ action: [String: Any], path: String, errors: inout [SCALSValidationError], warnings: inout [String]) {
...
public extension SCALSValidator {
    ...
    func validateAndDecode(jsonString: String) throws -> Document.Definition {
        ...
        if !result.isValid {
            if result.errors.count == 1 {
                ...
                throw SCALSValidationError.multipleErrors(result.errors)
            }
        }
        guard let document = result.document else {
            throw SCALSValidationError.decodingFailed(underlying: NSError(domain: "SCALSValidator", code: -1, userInfo: [NSLocalizedDescriptionKey: "Document was nil after validation"]))
        }
        return document
    }
