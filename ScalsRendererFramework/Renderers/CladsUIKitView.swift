...
/// Delegate protocol for ScalsUIKitView callbacks
@MainActor
...
/// Main UIKit view for rendering SCALS documents with delegate callbacks and efficient updates
public final class ScalsUIKitView: UIView {

    // MARK: - Public Properties

    /// Delegate for receiving callbacks
    public weak var delegate: ScalsRendererDelegate?
    ...
    public init(
        ...
        do {
            ...
            print("ScalsUIKitView: Resolution failed - \(error)")
...
/// Button that notifies the ScalsUIKitView delegate
private final class DelegateActionButton: UIButton {
    private let actionBinding: Document.Component.ActionBinding?
    private weak var cladsView: ScalsUIKitView?

    init(actionBinding: Document.Component.ActionBinding?, cladsView: ScalsUIKitView) {
...
open class ScalsViewController: UIViewController, ScalsRendererDelegate {
    ...
    public init(document: Document.Definition, actionRegistry: ActionRegistry = .shared) {
        ...
        cladsView = ScalsUIKitView(document: document, actionRegistry: actionRegistry)
