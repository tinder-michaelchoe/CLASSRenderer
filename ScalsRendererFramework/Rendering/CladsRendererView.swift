...
/// Configuration for ScalsRendererView with external state binding
public struct ScalsRendererConfiguration<State: Codable> {
...
public struct ScalsRendererBindingView<State: Codable & Equatable>: View {
    ...
    private let configuration: ScalsRendererConfiguration<State>
    ...
    public init(
        document: Document.Definition,
        state: Binding<State>,
        configuration: ScalsRendererConfiguration<State> = ScalsRendererConfiguration()
    ) {
...
class BindingRenderContext<State: Codable>: ObservableObject {
    ...
    @MainActor
    init(document: Document.Definition, configuration: ScalsRendererConfiguration<State>) {
        self.configuration = configuration
