//
//  SCALSExamplesJSON.swift
//  ScalsRenderer
//
//  JSON definitions for SCALS-organized examples.
    ...
    "children": [{
      ...
      "sections": [
        ...
        },
        {
          ...
          "header": {
            "type": "label", "text": "Card Paging ⭐️ UPDATED", "styleId": "header",
            "padding": { "bottom": 12 }
          },
          "children": [
            {
              ...
              "children": [
                ...
                },
                {
                  ...
                  "alignment": "center",
                  "children": [
                    { "type": "label", "text": "🌱", "styleId": "pageEmoji" },
...
// MARK: - Complex Examples (Combining SCALS Elements)
...
public let cardPagingJSON = """
{
  "id": "card-paging-example",
  "version": "1.0",
  "state": { "currentPage": 0 },
  "styles": {
    "pageCard": {
